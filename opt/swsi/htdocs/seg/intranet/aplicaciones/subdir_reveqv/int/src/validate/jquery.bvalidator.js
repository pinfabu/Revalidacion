		...
		var options = {
			...
			errorMessages: {
				en: {
					...
					'differs':    'Introduzca un valor diferente.',
					...
					'min':        'Introduzca un numero mayor o igual que {0}.',
					'max':        'Introduzca un numero menor o igual que {0}.',
					'between':    'Introducza un numero entre {0} y {1}.',
					'required':   'Campo obligatorio.',
					'alpha':      'Introduzca sólo caracteres alfabéticos.',
					'alphanum':   'Introduzca sólo caracteres alfanuméricos.',
					'digit':      'Introduzca sólo dígitos.',
					...
					'ip4':        'Introduzca una dirección IPv4 válida',
					'ip6':        'Introduzca una dirección IPv6 válida',
					'date':       'Introduzca una fecha válida con el formato {0}.'
				}
			}
		},
