...
if($opt == "getFolio"){
	...
	$data->Nombre_sol = utf8_encode($data->Nombre_sol);
	$data->Ap_Paterno_sol = utf8_encode($data->Ap_Paterno_sol);
	$data->Ap_Materno_sol = utf8_encode($data->Ap_Materno_sol);
