...
$sql = "SELECT nombre, Ap_Paterno, Ap_Materno, usrname, email, idperfil,fecha_alta, fecha_ult_acceso, ip_user , cat_usuarios.IdEmpleado FROM cat_usuarios, empleados\n"
    . "where idperfil = '".$q."' AND cat_usuarios.IdEmpleado = empleados.IdEmpleado";
